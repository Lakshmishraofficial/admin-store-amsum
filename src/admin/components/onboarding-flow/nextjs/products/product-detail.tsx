  ...
  return (
    <div>
      <div className="flex flex-col gap-2">
        <Text>
          We have now created a few sample products in your Amsum store. You can scroll down to see what the Product Detail view looks like in the Admin dashboard.
          This is also the view you use to edit existing products.
        </Text>
        <Text>
          To view the products in your store, you can visit the Amsum Storefront that was installed with <code></code>. 
        </Text>
        <Text>
          The Amsum Storefront Starter is a template that helps you start building an ecommerce store with Medusa. 
          You control the code for the storefront and you can customize it further to fit your specific needs.
        </Text>
        <Text>
          Click the button below to view the products in your Amsum Storefront.
        </Text>
        <Text>
